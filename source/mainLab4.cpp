...
//Teapot
const char *textureName = "./textures/checkered.jpeg";


unsigned int Mode1Texture, Mode2Texture, Mode3Texture, Mode4Texture, Mode5Texture;
bool key1 = true;
bool key2 = false;
bool key3 = false;
bool key4 = false;
...
MESH TO LOAD
----------------------------------------------------------------------------*/
#define SQUARE_MESH "./models/floor.obj"
#define BACKPACK_MESH "./models/floor.obj"
#define TEAPOT_MESH "./models/floor.obj"
/*----------------------------------------------------------------------------
----------------------------------------------------------------------------*/
...
void display() {
    ...
    if(key1){
        ...
        RenderText(textShaderProgramID, "No mipmapping", 320.0f, 580.0f, 0.8f, glm::vec3(1.0f, 0.0f, 0.0f));
    }
    else if(key2){
        glEnable(GL_BLEND);
        glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
        ...
        glUseProgram(textShaderProgramID);
        glUniformMatrix4fv(glGetUniformLocation(textShaderProgramID, "proj"), 1, GL_FALSE, glm::value_ptr(projection));
        RenderText(textShaderProgramID, "GL_NEAREST_MIPMAP_NEAREST", 320.0f, 580.0f, 0.8f, glm::vec3(1.0f, 0.0f, 0.0f));
    }
    else if(key3){
        glEnable(GL_BLEND);
        glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
        ...
        glUseProgram(textShaderProgramID);
        glUniformMatrix4fv(glGetUniformLocation(textShaderProgramID, "proj"), 1, GL_FALSE, glm::value_ptr(projection));
        RenderText(textShaderProgramID, "GL_LINEAR_MIPMAP_NEAREST", 320.0f, 580.0f, 0.8f, glm::vec3(1.0f, 0.0f, 0.0f));
    }
    else if(key4){
        ...
        glUseProgram(textShaderProgramID);
        glUniformMatrix4fv(glGetUniformLocation(textShaderProgramID, "proj"), 1, GL_FALSE, glm::value_ptr(projection));
        RenderText(textShaderProgramID, "GL_NEAREST_MIPMAP_LINEAR", 320.0f, 580.0f, 0.8f, glm::vec3(1.0f, 0.0f, 0.0f));
    }
    else{
        glEnable(GL_BLEND);
        glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
        ...
        glUseProgram(textShaderProgramID);
        glUniformMatrix4fv(glGetUniformLocation(textShaderProgramID, "proj"), 1, GL_FALSE, glm::value_ptr(projection));
        RenderText(textShaderProgramID, "GL_LINEAR_MIPMAP_LINEAR", 320.0f, 580.0f, 0.8f, glm::vec3(1.0f, 0.0f, 0.0f));
    }
...
{
    // Set up the shaders
	reflectionShaderProgramID = CompileShaders("./shaders/mipmappingVertexShader.txt", "./shaders/mipmappingFragmentShader.txt");
    ...
    // Textures
    // Textures
    Mode1Texture = loadTexture(textureName, 1);
    Mode2Texture = loadTexture(textureName, 2);
    Mode3Texture = loadTexture(textureName, 3);
    Mode4Texture = loadTexture(textureName, 4);
    Mode5Texture = loadTexture(textureName, 5);
...
int main(int argc, char** argv) {
	...
	glutCreateWindow("Lab 4 mip-map");
